...
function[couleurZbuffer, new]= PerspectiveInv( listeTriangle,Pox, Poy, Poz,Prx,Pry,Prz,d,Six,Siy,Siz)
...
%   Detailed explanation goes here
    ...
    for i=1:1:x
       ...
       if ((listeTriangle(i,3)+listeTriangle(i,6)+listeTriangle(i,9))/3)<591
         ...
         %zh= fill( [Atrans(1);Btrans(1);Ctrans(1)], [Atrans(2);Btrans(2);Ctrans(2)],couleurZbuffer(i,:) );
